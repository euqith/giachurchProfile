...
(function ($) {
	...
	var sliderInit1 = new Swiper(sliderActive1, {
		...
		navigation: {
			// ✅ Ditambahkan selektor .swiper-button-next & .swiper-button-prev agar langsung mengikat tombol baru kita
			nextEl: ".banner-two__arry-next, .swiper-button-next",
			prevEl: ".banner-two__arry-prev, .swiper-button-prev",
		},
	});
	...
	// 📄 Slider Khusus Warta Jemaat Digital (Gerakan Seamless & Instan)
	// 📄 Slider Khusus Warta Jemaat Digital (Gerakan Seamless & Instan)
	var sliderWarta = ".warta__slider";
	var wartaInit = new Swiper(sliderWarta, {
		loop: false,
		slidesPerView: 1,
		effect: "slide",
		speed: 300,
		navigation: {
			// ✅ Ganti target elemen tombolnya ke kelas custom kita yang baru
			nextEl: ".about-area .btn-warta-next",
			prevEl: ".about-area .btn-warta-prev",
		},
	});
